...
const HeroSection = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const SHEETS_URL = 'https://script.google.com/macros/s/AKfycbyGTGQP1ynl81BcToE-LC0Mb-N6ypax2X_1esbYtYFaSytCsob30jB7kr_vQob3yfiA/exec';
    ...
    setTimeout(() => {
      window.location.href = 'https://obrigado35.institutodespertamente.site/';
    }, 2000);
  };
